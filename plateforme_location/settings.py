"""
Django settings for plateforme_location project.
...
SECRET_KEY = 'django-insecure-inls623ek-9r+8&4&bg3^rc(6ciu%qv-@p+m+n@0g0(gmi4hh2'
...
ROOT_URLCONF = 'plateforme_location.urls'
...
WSGI_APPLICATION = 'plateforme_location.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'projet_location_uvbf',  # Nom de ta base de données PostgreSQL
